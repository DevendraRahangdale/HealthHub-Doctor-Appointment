...
console.log("Appointment status:", appointment.status);
  ...
  return (
    <>
      <Card className="border border-emerald-800/25 bg-gradient-to-br from-emerald-950/40 to-emerald-900/20 rounded-xl shadow-md hover:shadow-lg hover:border-emerald-600 transition-all duration-300">
        <CardContent className="p-5">
          <div className="flex flex-col md:flex-row justify-between gap-6">
            {/* LEFT SIDE: Doctor/Patient Info */}
            <div className="flex items-start gap-4">
              <div className="bg-emerald-900/30 rounded-full p-2 mt-1 border border-emerald-800/30">
                {otherPartyIcon}
              </div>
              ...
              <div>
                ...
                {userRole === "DOCTOR" && (
                  <p className="text-sm text-emerald-300">{otherParty.email}</p>
                )}
            ...
            <div className="flex flex-col items-end gap-2 self-end md:self-start">
              <Badge
                variant="outline"
                className={`px-3 py-1 text-xs tracking-wide rounded-full ${
              ...
              <div className="flex gap-2 flex-wrap mt-1">
                {canMarkCompleted() && (
                  <Button
                    ...
                    className="bg-emerald-600 hover:bg-emerald-700 text-white font-medium transition"
                  >
                    {completeLoading ? (
                ...
                <Button
                  size="sm"
                  variant="outline"
                  className="border-emerald-800/30 text-emerald-300 hover:border-emerald-500 transition"
  ...
  <p className="text-sm text-red-400 italic mt-1">
    This appointment has been cancelled and cannot be marked as completed.
  </p>
)}
            </div>
          </div>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="max-w-2xl border-emerald-300">
          <DialogHeader>
